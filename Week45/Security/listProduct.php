...
<body>
	...
	?>
	<div class="container">
		<h2>Welcome, <?php echo $_SESSION['login']; ?> <button class="btn btn-default btn-logout">Log Out</button></h2>
		<h2>List Blogs <button class="btn btn-default" data-toggle="modal" data-target="#add-blog-modal">Add Blog</button></h2>
	...
	<script>
		$(function() { 
			$("#form-add-blog").submit(function(event){
